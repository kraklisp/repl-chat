...
(defun chat-login (nickname)
  (setf *chat-data*
	(seta *chat-data* nickname
	      (two-way-stream-output-stream *terminal-io*))) 
  t)
(defun chat-logout ()
  (setf *chat-data*
	(remove (rassoc (two-way-stream-output-stream *terminal-io*) *chat-data*)
		*chat-data*))
  t)
(defun chat-whois ()
...
(defun msg-priv (nickname message)
  (let ((my-nickname (car (rassoc (two-way-stream-output-stream *terminal-io*)
				  *chat-data*)))
